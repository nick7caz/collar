            ...
            return SingleChildScrollView(
              ...
              children: [
                CardProfile(
                  ...
                  petName: _currentUser.petName,
                  relationGoal: _currentUser.relationGoal,
                  // petPhoto: _currentUser.petPhoto,
                  petSize: _currentUser.petSize,
                  petBio: _currentUser.petBio,
                  kids: _currentUser.kids,
                  religion: _currentUser.religion,
                  jobTitle: _currentUser.jobTitle,
                  school: _currentUser.school,
                  zodiac: _currentUser.zodiac,
                ),
              ],
            ));
          } else
